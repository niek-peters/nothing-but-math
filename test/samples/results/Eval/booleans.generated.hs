...
module TestModule (TestModule.isPos, TestModule.isNat, TestModule.isNeg, TestModule.nonNeg, TestModule.nonZero, TestModule.oneOrTwo, TestModule.neitherOneOrTwo) where
...
isPos :: Integer -> Bool
isPos x
  | otherwise = x > (widen @Integer (0 :: Natural))
...
nonNeg :: Integer -> Bool
nonNeg x
  | otherwise = not (TestModule.isNeg x)

nonZero :: Integer -> Bool
nonZero x
  | otherwise = x /= (widen @Integer (0 :: Natural))

oneOrTwo :: Integer -> Bool
oneOrTwo x
  | otherwise = (x == (widen @Integer (1 :: Positive))) || (x == (widen @Integer (2 :: Positive)))

neitherOneOrTwo :: Integer -> Bool
neitherOneOrTwo x
  | otherwise = (x /= (widen @Integer (1 :: Positive))) && (not (x == (widen @Integer (2 :: Positive))))
